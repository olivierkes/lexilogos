...
#
# Created: Sat Jun 15 09:12:36 2013
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.plainTextEdit_original = QtGui.QPlainTextEdit(self.centralwidget)
        ...
        self.plainTextEdit_version = QtGui.QPlainTextEdit(self.centralwidget)
        ...
        self.pushButton_cheatText = QtGui.QPushButton(self.centralwidget)
        ...
        QtCore.QObject.connect(self.pushButton_cheatText, QtCore.SIGNAL(_fromUtf8("toggled(bool)")), self.plainTextEdit_version.setShown)
        QtCore.QObject.connect(self.pushButton_moreOptions, QtCore.SIGNAL(_fromUtf8("toggled(bool)")), self.widget.setShown)
        QtCore.QMetaObject.connectSlotsByName(MainWindow)

    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(_translate("MainWindow", "MainWindow", None))
        self.plainTextEdit_original.setPlainText(_translate("MainWindow", "1   Ἐν  ἀρχῇ  ἦν  ὁ  λόγος,  καὶ  ὁ  λόγος  ἦν  πρὸς  τὸν  θεόν,  καὶ  θεὸς  ἦν  ὁ  λόγος.  2   οὗτος  ἦν  ἐν  ἀρχῇ  πρὸς  τὸν  θεόν.  3   πάντα  δι’  αὐτοῦ  ἐγένετο,  καὶ  χωρὶς  αὐτοῦ  ἐγένετο  οὐδὲ  ἓν  ὃ  γέγονεν  4   ἐν  αὐτῷ  ζωὴ  ἦν,  καὶ  ἡ  ζωὴ  ἦν  τὸ  φῶς  τῶν  ἀνθρώπων·  5   καὶ  τὸ  φῶς  ἐν  τῇ  σκοτίᾳ  φαίνει  καὶ  ἡ  σκοτία  αὐτὸ  οὐ  κατέλαβεν.  ", None))
        self.pushButton_cheatText.setText(_translate("MainWindow", "?", None))
        self.groupBox_5.setTitle(_translate("MainWindow", "Answers", None))
        self.pushButton_4.setText(_translate("MainWindow", "→", None))
        self.pushButton_3.setText(_translate("MainWindow", "←", None))
        self.pushButton_Validate.setText(_translate("MainWindow", "Validate", None))
